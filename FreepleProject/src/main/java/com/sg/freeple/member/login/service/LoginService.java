...
public class LoginService {
	...
	public FP_MemberVo loginProcess(FP_MemberVo memberVo) {
		
		return loginSQLMapper.selectByIdAndPw(memberVo);
	}

	// 20240915
	// 로그인 시도했는데 ID는 맞는데 PW가 틀리면 로그인 실패 횟수 증가
	public void loginFailIncrease(FP_MemberVo memberVo){
		loginSQLMapper.loginFailIncrease(memberVo);
	}
