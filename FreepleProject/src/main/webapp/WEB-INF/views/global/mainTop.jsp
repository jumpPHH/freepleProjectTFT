							...
							<div class="row">
								...
								<c:if test="${empty serverUserInfo}">
									...
									<div class="col-2 text-center" style="width: auto;">
										<a href="/member/signup/signupPage"
											style="color: #ab79d1; text-decoration: none">회원가입</a>
									</div>
									<div class="col-2 text-center" style="width: auto;">
										<a href="/member/login/loginPage"
								...
								<c:if test="${not empty serverUserInfo}">
									<div class="col-2 text-center" style="width: auto;">
										<a href="/main/myPage"
											style="color: #ab79d1; text-decoration: none;">${serverUserInfo.mb_nick}님</a>
									</div>
									<div class="col-2 text-center" style="width: auto;">
										<a href="/member/login/logoutProcess"
